...
#---------------------------------------------------------------------
#Top atacador y victima 
c1, c2,c3,c4,c5 = st.beta_columns((1,1,1,1,1))
c1.markdown("<h3 style='text-align: left; color: black;'> Top sexo </h3>", unsafe_allow_html=True)
...
c2.markdown("<h3 style='text-align: left; color: black;'> Top raza </h3>", unsafe_allow_html=True)
...
c3.markdown("<h3 style='text-align: left; color: black;'> Top por edad </h3>", unsafe_allow_html=True)
...
c4.markdown("<h3 style='text-align: left; color: black;'> Top por barrio </h3>", unsafe_allow_html=True)
...
c5.markdown("<h3 style='text-align: left; color: black;'> Top por hora </h3>", unsafe_allow_html=True)
